...
export const FULL_BODY_MOODS = new Set<BrewMood>([
  'hero', 'pouring', 'jump', 'dance', 'hello', 'dab', 'workout', 'bad', 'heart', 'celeb', 'redred',
]);
...
export type BrewOneShot = { key: 'wave' | 'jump' | 'dance' | 'dab' | 'jacks' | 'bad' | 'heart' | 'celeb' | 'redred'; token: number };
