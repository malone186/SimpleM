...
export const FLIPBOOK_MOODS = new Set<BrewMood>(['jump', 'dance', 'hello', 'dab', 'workout', 'bad', 'heart', 'celeb']);
...
export const FULL_BODY_MOODS = new Set<BrewMood>([
  'hero', 'pouring', 'jump', 'dance', 'hello', 'dab', 'workout', 'bad', 'heart', 'celeb',
]);
...
export type BrewOneShot = { key: 'wave' | 'jump' | 'dance' | 'dab' | 'jacks' | 'bad' | 'heart' | 'celeb'; token: number };
