...
_SUBAGENTS = [
    ...
    {"name": "qa_chatbot", "title": "챗봇 오케스트레이션 검증", "status": "경미한 문제",
     "note": "쿼터 선차감·실패 환불 정상. 광고 보상 충전이 클라이언트 보고만 신뢰(일일 상한으로 완화) — 알려진 한계."},
    ...
    {"name": "qa_checklist_etc", "title": "체크리스트·문의·리워드 검증", "status": "경미한 문제",
     "note": "체크리스트·리워드 정상. 문의 등록의 비인증 폴백은 구버전 호환 임시 조치로 문서화됨."},
