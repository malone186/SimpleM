...
_DOMAINS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "title": "메뉴 개선 전문가",
        "description": (
            "메뉴를 바꾸려는 안이 괜찮은지 실제 판매·원가로 점검한다: 가격 인상·인하, "
            "메뉴 단종, 신메뉴 추가, 재료 교체로 인한 원가 절감의 효과와 위험. "
            "지금 메뉴 구성 진단(팔수록 손해인 메뉴, 재료비 비중이 높은 메뉴, 이익 쏠림)도 한다. "
            "'아메리카노 500원 올려도 될까?', '이 메뉴 빼도 돼?', '메뉴를 이렇게 바꿔봤는데 어때?', "
            "'6000원짜리 신메뉴 넣으면?', '메뉴 구성 좀 봐줘' 같은 요청을 처리한다. "
            "메뉴 등록·레시피 수정 자체는 재고 전문가 담당이다."
        ),
